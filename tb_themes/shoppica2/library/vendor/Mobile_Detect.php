...
class Mobile_Detect {
    ...
    */
    ...
    {
        return $this->isMobile || $this->alternativeMobileDetection();
    }
    ...
    */
    ...
    public function isPhoneDevice()
    {
        ...
        foreach($this->phoneDevices as $_key => $_regex){
            if(preg_match('/'.$_regex.'/is', $this->userAgent)){
                $this->isTablet = true;
                return true;
            }
