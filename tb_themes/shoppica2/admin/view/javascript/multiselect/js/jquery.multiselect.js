...
$.widget("ech.multiselect", {
	...
	_create: function(){
		...
		var 
			button = (this.button = $('<span><span class="ui-icon ui-icon-triangle-2-n-s"></span></span>'))
	...
	refresh: function( init ){
		...
		el.find('option').each(function( i ){
			...
			// create the label
			html.push('<label for="' + inputID + '" title="' + description + '" class="s_checkbox ' + labelClasses.join(' ') + '">');
