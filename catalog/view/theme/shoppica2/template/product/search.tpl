    ...
    <div id="search_results" class="s_main_col">
      ...
      <div id="adv_search_box">
        ...
        <div class="s_mb_0 clearfix">
          <input id="search_input" type="text" name="filter_name" class="filter_keyword s_sep" value="<?php echo $search; ?>" size="50" />
        ...
        <div class="s_row_3 clearfix">
          <label class="s_checkbox" for="sub_category"><input type="checkbox" name="sub_category" value="1" id="sub_category"<?php if ($sub_category): ?> checked="checked"<?php endif; ?> /> <?php echo $text_sub_category; ?></label>
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            <li id="view_grid"<?php if($tbData->product_listing_type == 'grid') echo ' class="s_selected"';?>>
              <a href="<?php echo $this->url->link('product/search', 'search=' . $search . '&setListingType=grid'); ?>" rel="nofollow">
            ...
            <li id="view_list"<?php if($tbData->product_listing_type == 'list') echo ' class="s_selected"';?>>
              <a href="<?php echo $this->url->link('product/search', 'search=' . $search . '&setListingType=list'); ?>" rel="nofollow">
