...
<!--  Latest Content  -->
<!-- ---------------- -->
<?php $products = $tbSlot->filter('module\latest.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\latest_content.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
<div class="s_module_latest s_module_content">
  ...
  <div class="s_listing s_grid_view <?php echo $tbData->common['products_per_row']; ?> clearfix">
    ...
    <?php $tbSlot->start('module\latest_content.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
...
<!-- --------------- -->
<?php $products = $tbSlot->filter('module\latest.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\latest_column.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
<div class="s_box clearfix">
  <h2><?php echo $heading_title; ?></h2>

  <?php foreach ($products as $product): ?>
  <?php $tbSlot->start('module\latest_column.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
