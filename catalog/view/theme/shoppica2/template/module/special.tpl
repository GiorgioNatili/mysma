...
<!--  Special Content  -->
<!-- ----------------- -->
<?php $products = $tbSlot->filter('module\special.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\special_content.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
...
<!-- ---------------- -->
<?php $products = $tbSlot->filter('module\special.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\special_column.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
<div class="s_box clearfix">
  <h2><?php echo $heading_title; ?></h2>

  <?php foreach ($products as $product): ?>
  <?php $tbSlot->start('module\special_column.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
