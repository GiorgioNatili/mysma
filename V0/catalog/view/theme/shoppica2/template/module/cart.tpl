<?php if ($products || $vouchers): ?>
  ...
  <div class="align_center clearfix">
    <a class="s_button_1 s_secondary_color_bgr s_ml_0" href="<?php echo $this->url->link('checkout/cart'); ?>"><span class="s_text"><?php echo $tbData->text_cart_view; ?></span></a>
    <a class="s_button_1 s_secondary_color_bgr" href="<?php echo $checkout; ?>"><span class="s_text"><?php echo $text_checkout; ?></span></a>
  </div>
