...
<!--  Bestseller Content  -->
<!-- -------------------- -->
<?php $products = $tbSlot->filter('module\bestseller.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\bestseller_content.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
<div class="s_module_bestseller s_module_content">
  ...
  <div class="s_listing s_grid_view <?php echo $tbData->common['products_per_row']; ?> clearfix">
    ...
    <?php $tbSlot->start('module\bestseller_content.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
...
<!-- ------------------- -->
<?php $products = $tbSlot->filter('module\bestseller.filter_products', $products, array('data' => $this->data)); ?>
<?php $tbSlot->start('module\bestseller_column.products_listing', array('products' => $products, 'data' => $this->data)); ?>
<?php if ($products): ?>
<div class="s_box clearfix">
  <h2><?php echo $heading_title; ?></h2>

  <?php foreach ($products as $product): ?>
  <?php $tbSlot->start('module\bestseller_column.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
