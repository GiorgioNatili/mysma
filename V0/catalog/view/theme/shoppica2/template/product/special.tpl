<?php echo $header; ?>
  ...
  <div id="content" class="s_wrap">
    ...
    <div id="specials" class="s_main_col">
      ...
      <?php $products = $tbSlot->filter('product\special.filter_products', $products, array('data' => $this->data)); ?>
      <?php $tbSlot->start('product\special.products_listing', array('products' => $products, 'data' => $this->data)); ?>
      <?php if ($products): ?>
        ...
        <div id="view_mode" class="s_nav">
          <ul class="clearfix">
            <li id="view_grid"<?php if($tbData->product_listing_type == 'grid') echo ' class="s_selected"';?>>
              <a href="<?php echo $this->url->link('product/special', 'setListingType=grid'); ?>" rel="nofollow">
            ...
            <li id="view_list"<?php if($tbData->product_listing_type == 'list') echo ' class="s_selected"';?>>
              <a href="<?php echo $this->url->link('product/special', 'setListingType=list'); ?>" rel="nofollow">
      ...
      <div class="s_listing <?php if ($tbData->product_listing_type == 'list'): ?>s_list_view<?php  else: ?>s_grid_view<?php endif; ?> <?php echo $tbData->common['products_per_row']; ?> clearfix">
        ...
        <?php $tbSlot->start('product\special.products.each', array('products' => $products, 'product' => $product, 'data' => $this->data)); ?>
